...
MIDDLEWARE = [
    ...
    'restaurants.middleware.AdminAccessControlMiddleware',  # Restaurant admin access control
]
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_THROTTLE_RATES': {
        'ai': '20/min',      # Scoped throttle for AI endpoints
    },
}
...
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'noreply@restaurantms.com')
