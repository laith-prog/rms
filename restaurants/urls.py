...
urlpatterns = [
    ...
    path('<int:restaurant_id>/available-tables/', views.available_tables, name='available_tables'),
    path('<int:restaurant_id>/tables-by-floor/', views.available_tables_by_floor, name='available_tables_by_floor'),
    path('<int:restaurant_id>/reserve/', views.create_reservation, name='create_reservation'),
    path('<int:restaurant_id>/reserve-enhanced/', views.create_enhanced_reservation, name='create_enhanced_reservation'),
